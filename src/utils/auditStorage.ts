...
• Corrective Action: ${f.recommendedCorrectiveAction}`;
  ...
  return `${divider}
WOTAN — ENTERPRISE CONVERSATION QA & RISK REPORT
${divider}
Title: ${report.title}
Audit ID: ${report.id}
Timestamp: ${new Date(report.createdAt).toLocaleString()}
Audited By: ${report.metadata.auditedBy || 'WOTAN AI'} (${report.metadata.modelUsed})
...
${divider}
Generated by WOTAN Enterprise AI Compliance Engine
${divider}`;
}
